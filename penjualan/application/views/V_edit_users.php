...
<h2>Edit User</h2>
<form method="post">
<input type="text" name="fname" placeholder="Nama Depan "value="<?php echo
$edit -> first_name; ?>">
<input type="text" name="lname" placeholder="Nama Belakang "value="<?php echo
$edit -> last_name; ?>">
<input type="email" name="email" placeholder="Email "value = "<?php echo
$edit -> email; ?>">
<input type="password" name="password" placeholder="Password ">
<input type="hidden" name="password_lama" value="<?php echo
$edit -> password; ?>">
